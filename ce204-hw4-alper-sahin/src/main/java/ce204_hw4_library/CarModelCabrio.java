...
@file CarModelCabrio.java
@brief This file contains the implementation of the CarModelCabrio class.
*/
package ce204_hw4_library;

/**
 *
 * @class CarModelCabrio
 *
 * @brief Represents a cabrio car model for rental.
 */
public class CarModelCabrio implements RentCarInterface {
  ...
  /**
   *
   * @brief Constructs a CarModelCabrio object with the specified details.
   ...
   */
  public CarModelCabrio(int carSeatsNumber, int carPrice, String carColor, String carModel, String carBrand,
