...
@file CarModelSedan.java
@brief This file contains the implementation of the CarModelSedan class.
*/
 ...
 * @class CarModelSedan
 *
 * @brief Represents a sedan car model for rental.
 */
public class CarModelSedan implements RentCarInterface {
  ...
  /**
   *
   * @brief Constructs a CarModelSedan object with the specified details.
   ...
   */
  public CarModelSedan(int carSeatsNumber, int carPrice, String carColor, String carModel, String carBrand,
