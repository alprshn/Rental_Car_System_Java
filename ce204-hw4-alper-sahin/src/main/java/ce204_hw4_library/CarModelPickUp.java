...
@file CarModelPickUp.java
@brief This file contains the implementation of the CarModelPickUp class.
*/
package ce204_hw4_library;

/**
 *
 * @class CarModelPickUp
 *
 * @brief Represents a pick-up truck car model for rental.
 */
public class CarModelPickUp implements RentCarInterface {
  ...
  /**
   *
   * @brief Constructs a CarModelPickUp object with the specified details.
   ...
   */
  public CarModelPickUp(int carSeatsNumber, int carPrice, String carColor, String carModel, String carBrand,
