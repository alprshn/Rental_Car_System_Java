...
@file CarModelSUV.java
@brief This file contains the implementation of the CarModelSUV class.
*/
 ...
 * @class CarModelSUV
 * 
 * @brief Represents an SUV car model for rental.
 */
public class CarModelSUV implements RentCarInterface {
	...
	/**
	 * 
	 * @brief Constructs a CarModelSUV object with the specified details.
	 ...
	 */
	public CarModelSUV(int carSeatsNumber, int carPrice, String carColor, String carModel, String carBrand,
